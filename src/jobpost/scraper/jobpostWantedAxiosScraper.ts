                    ...
                    if (jobsList[i].status === 'active') {
                        ...
                        let deadlineDtm =
                            jobsList[i].due_time === null
                                ...
                                : jobsList[i].due_time
                        if (deadlineDtm !== null)
                            deadlineDtm = new Date(
                                `${deadlineDtm} 23:59:59.999`
                            )
                        ...
                        if (!allCompanyIds.includes(companyId)) {
                            ...
                            try {
                                ...
                                const numberEmployees =
                                    kreditjobCompanyEmploymentDetails.employee
                                        .total
                                const avgSalary =
                                    kreditjobCompanyEmploymentDetails.salary
                                        .salary
