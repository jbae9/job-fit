...
export class SaraminSelenium {
    ...
    async getSaraminScraper(pageCount: string) {
        ...
        while (true) {
            ...
            if (saraminScraper.exit === 1) {
                console.log('사람인 스크랩 끝')
                break
            }
                        ...
                        try {
                            ...
                            if (salaryText === '급여') {
                                ...
                                if (
                                    ...
                                    const salaryArr = salary.split(' ', 2)
                                    if (salaryArr[0] === '월급') {
                                        salary = (
                                            Number(
                                                salaryArr[1].replace(',', '')
                                        ...
                                        salary = salaryArr[1].replace(',', '')
                                    }
                                }
                            }
                            this.allJobsArr[index].salary =
                                Number(salary) * 10000
                            ...
                            const postedDtm = await allJobs
                                ...
                                .getText()
                            this.allJobsArr[index].postedDtm = new Date(
                                postedDtm
                            )
                            if (
                                this.allJobsArr[index].deadlineDtm.indexOf(
                                    '채용'
                                ) != -1
                            ) {
                            ...
                            if (
                                this.allCompanies[index]['numberEmployees'] !=
                                    null &&
                                typeof this.allCompanies[index][
                                    'numberEmployees'
                                ] == 'string'
                            ) {
                                this.allCompanies[index]['numberEmployees'] =
                            ...
                            if (
                                this.allCompanies[index]['foundedYear'] !=
                                    null &&
                                typeof this.allCompanies[index][
                                    'foundedYear'
                                ] == 'string'
                            ...
                            console.log('ERROR WHILE GETTING DETAILED PAGE')
                            console.log(error)
                            tries++
                        }
                    }
